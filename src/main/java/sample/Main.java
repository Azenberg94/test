...
public class Main extends Application {
    ...
    public void initRootLayout() {
        try {
            ...
            loader.setLocation(Main.class.getClassLoader().getResource("view/sample.fxml"));
    ...
    public void showConnection() throws IOException {
        try {
            ...
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(Main.class.getClassLoader().getResource("view/ConnectionView.fxml"));
    ...
    public void showHome() throws IOException {
        try {
            // Load home overview.
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(Main.class.getClassLoader().getResource("view/HomeView.fxml"));
    ...
    public void showProject() throws IOException {
        try {
            // Load home overview.
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(Main.class.getClassLoader().getResource("view/ProjectView.fxml"));
    ...
    public void showCalendar() throws IOException {
        try {
            // Load home overview.
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(Main.class.getClassLoader().getResource("view/CalendarView.fxml"));
    ...
    public void showSubscribe() throws IOException {
        try {
            // Load connexion overview.
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(Main.class.getClassLoader().getResource("view/SubscribeView.fxml"));
    ...
    public void showCreateProject() throws IOException {
        try {
            // Load connexion overview.
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(Main.class.getClassLoader().getResource("view/CreateProjectView.fxml"));
    ...
    public void showManageProject() throws IOException {
        try {
            // Load connexion overview.
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(Main.class.getClassLoader().getResource("view/ManageProjectView.fxml"));
    ...
    public void showCreateTask() throws IOException {
        try {
            // Load connexion overview.
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(Main.class.getClassLoader().getResource("view/CreateTaskView.fxml"));
            AnchorPane projectOverview = loader.load();
    ...
    public void showMyAccount() throws IOException {
        try {
            ...
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(Main.class.getClassLoader().getResource("view/AccountView.fxml"));
    ...
    public void showPlugin() throws IOException {
        try {
            // Load connexion overview.
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(Main.class.getClassLoader().getResource("view/PluginView.fxml"));
    ...
    public void showSharedFiles() throws IOException{
        try {
            ...
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(Main.class.getClassLoader().getResource("view/SharedFiles.fxml"));
